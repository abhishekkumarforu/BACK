...
public class LabRequestController {
    ...
    public List<TestRequest> getForTests()  {
        ...
        //This method gets the list of test requests having status as 'INITIATED' using the method findBy() from the class testRequestQueryService.
    ...
    public List<TestRequest> getForTester()  {
        ...
        // Creation of an object of User class and storing the current logged in tester.
            User tester = userLoggedInService.getLoggedInUser();


        //This method returns the list of test requests assigned to the tester who is logged in.
